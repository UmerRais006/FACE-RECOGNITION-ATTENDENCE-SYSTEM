    ...
    def __init__(self,root):
       ...
       #1
        ...
        b1_1 = Button(self.root, command=self.student_details, text="STUDENT DETAILS", cursor="hand2", 
              font=("times new roman", 12, "bold"), bg="white", fg="#000066")
        ...
        b1_1 = Button(self.root, text="FACE DETECTOR",command=self.face_data, cursor="hand2", font=("times new roman", 15, "bold"), bg="white", fg="#000066")
       ...
       #5
        ...
        b1=Button(self.root,image=self.photoimg6,cursor="hand2",command=self.train_data)
        b1.place(x=200,y=410,width=180,height=180)
        b1_1 = Button(self.root, text="TRAIN DATA",command=self.train_data, cursor="hand2", font=("times new roman", 12, "bold"), bg="white", fg="#000066")
       ...
       #6
        ...
        b1=Button(self.root,image=self.photoimg7,cursor="hand2",command=self.open_images)
        b1.place(x=440,y=410,width=180,height=180)
        b1_1 = Button(self.root, text="PHOTOS", cursor="hand2",command=self.open_images, font=("times new roman", 12, "bold"), bg="white", fg="#000066")
